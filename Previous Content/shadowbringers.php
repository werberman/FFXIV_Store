...
<head>
    <title> Shadowbringers (Old Content)</title>
    <link rel="stylesheet" href="../css/previous_content/shadowbringers.css">
...
<body>
    <div class="container">
        ...
        <div class="banner">
            <img src="../imgs/banner_shadowbringers.png">
            <div class="banner_title">Shadowbringers (Old Content)</div>
        </div>
        ...
        <div class="search">
            ...
            <a class="active">Shadowbringers</a>
    ...
    fight. No links required-->
        <?php
        $sql2 = "SELECT * FROM `products_all` WHERE item_name = 'Savage Bundle (E5S - E8S)'";
        ...
        while ($row = $results->fetch_assoc()) {
            ...
            <div class='item_contain'
                    ...
                    <div class=\"banner_item\">
                        <a href=\"../item_page.php?itemindex=$item_index_int\">
                            <img class='large_image' src=\"$item_banner_dir\"></a>
                            <div class=\"banner_title\">$item_name</div>      
                    </div>
        ...
        $sql2 = "SELECT * FROM `products_all` WHERE item_name LIKE '%s Verse%'";
        $results = $conn->query($sql2);
        while ($row = $results->fetch_assoc()) {
